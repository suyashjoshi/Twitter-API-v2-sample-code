...
Make sure you have Oracle JDK/OpenJDK version 8.0 or above isntalled on your machine, otherwise on mac you if you use Homebrew, you can install a Java runtime using:
